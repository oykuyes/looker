view: product_returned_csview {
  sql_table_name: `Looker.ProductReturnedCSView`
    ;;
  ...
  dimension: additional_product_return_amount {
    type: number
    sql: ${TABLE}.additional_product_return_amount ;;
  }
  ...
  dimension: cargo_firm {
    type: string
    sql: ${TABLE}.cargo_firm ;;
  }
  ...
  dimension: total_return_amount {
    type: number
    sql: ${TABLE}.total_return_amount ;;
  }
